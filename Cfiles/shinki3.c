...
int main(void)
{
    ...
    printf("<link href=\"shinki.css\" rel=\"stylesheet\" type=\"text/css\">\n");
    printf("<title>新規登録</title>\n");
    printf("</head>\n");
    printf("<body>\n");
    printf("<form name=\"login_form\" action=\"registration.exe\" method=\"post\">\n");
    printf("<div class=\"shinki_form_top\">\n");
    printf("<h1>新規登録</h1>\n");
    printf("<h2>必須項目を入力後、登録ボタンへ</h2>\n");
    printf("</div>\n");
    printf("<div class=\"login_form_btm\">\n");
    printf("<p>氏名フリガナ(セイ)　　　　(メイ)</p><p2>必須</p2>\n");
    printf("<input class=\"name_input\" type=\"lastnamef\" id=\"lastnamef\" name=\"lastnamef\" placeholder=\"タナカ\"><input class=\"name_input\" type=\"firstnamef\" id=\"firstnamef\" name=\"firstnamef\" placeholder=\"タロウ\" ><br><br>\n");
    printf("<h5 id=\"namefError\"></h5>\n");
    printf("<p>氏名(姓)　　　　　　　　　(名)</p><p2>必須</p2>\n");
    printf("<input class=\"name_input\" type=\"lastname\" id=\"lastname\" name=\"lastname\" placeholder=\"田中\" ><input class=\"name_input\"  type=\"firstname\" id=\"firstname\" name=\"firstname\" placeholder=\"太郎\"><br><br>\n");
    printf("<h5 id=\"nameError\"></h5>\n");
    printf("<p>ユーザーネーム(1文字以上20文字以内)</p><p2>必須</p2>\n");
    printf("<input class=\"name_input\"  type=\"user_name\" id=\"user_name\" name=\"user_name\" placeholder=\"例) わらびもち\"><br>\n");
    printf("<h5 id=\"user_nameError\"></h5>\n");
    printf("<p>ユーザー ID(半角英数字8文字以上20文字以内)</p><p2>必須</p2>\n");
    printf("<input class=\"name_input\"  type=\"user_id\" id=\"user_id\" name=\"user_id\" placeholder=\"例) warabi1\"><br>\n");
    printf("<h5 id=\"user_idError\"></h5>\n");
    printf("<p>パスワード(英数字8文字以上20文字以内)</p><p2>必須</p2>\n");
    printf("<input class=\"name_input\"  type=\"password1\" id=\"password1\" name=\"password1\"placeholder=\"例) abcdef1234\">\n");
    printf("<h5 id=\"password1Error\"></h5>\n");
    printf("<p>パスワード確認(再度入力)</p><p2>必須</p2>\n");
    printf("<input class=\"name_input\"  type=\"password2\" id=\"password2\" name=\"password2\"placeholder=\"パスワード確認\">\n");
    printf("<h5 id=\"password2Error\"></h5>\n");
    printf("<p>住所</p><p2>必須</p2>\n");
    printf("<select name=\"pref\" class=\"pref_select\">\n");
    printf("<option value=\"\">選択してください</option>\n");
    ...
    printf("<option value=\"東京都\" selected>東京都</option>\n");
    ...
    printf("</select>\n");
    printf("<input class=\"pref_input\" type=\"address\" id=\"address\" name=\"address\" placeholder=\"市町村番地\">\n");
    printf("<h5 id=\"addressError\"></h5>\n");
    printf("<p>メールアドレス</p><p2>必須</p2>\n");
    printf("<input class=\"name_input\"  type=\"email\" id=\"email\" name=\"email\" placeholder=\"例) example@mail.com\">\n");
    printf("<h5 id=\"emailError\"></h5>\n");
    printf("<p>電話番号</p><p2>必須</p2>\n");
    printf("<input class=\"name_input\"  type=\"phone\" id=\"phone\" name=\"phone\" placeholder=\"例) 01023456789\">\n");
    printf("<h5 id=\"phoneError\"></h5>\n");
    printf("<label>\n");
      printf("<p>誕生日</p><p2>必須</p2>\n");
      printf("</label>\n");
     
      printf("<p>");
      printf("<select class=\"birth_select\" name=\"birthyear\" id=\"birthyear\">\n");
      ...
      printf("</select>\n");
      printf("</select> 年\n");
        printf("<select class=\"birth_select\"  name=\"birthmonth\" id=\"birthmonth\">\n");
        printf("<option value=\"\">-</option>\n");
        for (int month = 1; month <= 12; month++) {
            printf("<option value=\"%02d\">%d</option>\n", month, month);
        }
        printf("</select> 月\n");
        printf("<select class=\"birth_select\"  name=\"birthday\" id=\"birthday\">\n");
        printf("<option value=\"\">-</option>\n");
        ...
        printf("<p>性別</p><p2>必須</p2></p>\n");
        printf("<div class=\"radio_btn\">\n");
        printf("<label class=\"radio_label\">男</label>");
        printf("<input type=\"radio\" name=\"gender\" value=\"0\"/>\n");
        printf("<label class=\"radio_label\">女</label>");
        printf("<input type=\"radio\" name=\"gender\" value=\"1\"/>\n");
        printf("<label class=\"radio_label\">その他</label>");
        printf("<input type=\"radio\" name=\"gender\" value=\"2\"/>\n");
        printf("</div>\n");
        printf("</select>\n");
        ...
        printf("</div>\n");
        printf("<p></p>\n");
        printf("<button type=\"registration\" onclick=\"namefInput(event), nameInput(event), user_nameInput(event),  user_idInput(event), passwordInput(event), addressInput(event), emailInput(event), phoneInput(event), birthdayInput(event), genderInput(event);\">登録</button>\n");
        printf("</form>\n");
